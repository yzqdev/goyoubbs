...
func main() {
	...
	// KvEach
	db.Hscan("myhmset", nil, 100).KvEach(func(key, value BS) {
	...
	db.Zset("test", I2b(2017), 5002)
	db.Zset("test", I2b(2018), 5001)
	db.Zset("test", I2b(2016), 4999)
	db.Zset("test", I2b(2011), 4000)

	rs = db.Zscan("test", I2b(2016), I2b(4999), 2)
	fmt.Println(B2i(rs.Data[0]), B2i(rs.Data[1]))
	...
	fmt.Println("------")
	rs = db.Zscan("test2", []byte("2017"), I2b(5000), 2)
	fmt.Println(string(rs.Data[0]), B2i(rs.Data[1]))

	//rs = db.Zrscan("test", I2b(2017), I2b(5002), 1)
	//fmt.Println(B2i(rs.Data[0]), B2i(rs.Data[1]))
